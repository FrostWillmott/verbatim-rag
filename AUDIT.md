...
| Cognitive debt | 59/100 | 5 | 4 | 1 | 0 | 0 |
...
| Dead code | 57 | **59** | Five of six named deductions removed, raw score 96 — the only one left standing is the −4 for the service layer, which is `DEAD-4` and still a question. An earlier version of this row said four and 91, holding a deduction for `DEAD-5` that the register marks `done`; the published figure does not move either way, because the report's cap of 59 for "findings on several surfaces at once" binds at both |
